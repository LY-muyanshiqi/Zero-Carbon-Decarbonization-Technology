...
TN_IN = 30.0                # mg/L
TN_EFF = 7.0                # mg/L
Q_DAY = 184000.0            # m3/d, 由 7043万kWh/0.38/365 反算约18.4万
SEC = 0.38                  # kWh/m3 吨水电耗, Water Research X 2576厂统计
...
MODULE3_DIR = os.path.dirname(BASE_DIR)                        # 模块三/
PROJECT_DIR = os.path.dirname(MODULE3_DIR)                     # 公用/
RAW_DATA_DIR = os.path.join(PROJECT_DIR, "2-原始数据文件")      # 原始数据目录

# 节点电价文件（含日前/实时电价，单位元/MWh）
PRICE_XLSX = os.path.join(RAW_DATA_DIR, "电力天气整合数据_逐小时.xlsx")
